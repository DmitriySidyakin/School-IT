...
Граф состоит из точек (узлов, вершин) *(V, Vertex, graph node)* и рёбер *(E, Edge)*, соединяющих вершины. Вот пример графа:
