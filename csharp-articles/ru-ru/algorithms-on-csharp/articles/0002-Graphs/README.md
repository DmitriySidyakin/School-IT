...
Каждое ребро ![Рис. 9. Граф, не являющейся деревом, с циклическими связями.](img/f01eE.PNG) Е представляется парой (*u*, *v*), узел *u* называется начальным, узел *v* - конечным.
...
Пусть строиться путь от начального узла до конечного, что является входными данными (начальный и конечный узел). Кратчайший путь в обычном графе называется путь с наименьшим количеством рёбер от начального узла до конечного.
