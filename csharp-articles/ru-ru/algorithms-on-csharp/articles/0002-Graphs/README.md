...
![Рис. 9. Граф, не являющийся деревом, с циклическими связями.](img/graph-cyclical.svg)
...
Каждое ребро ![Рис. 9. Граф, не являющейся деревом, с циклическими связями.](img/f01eE.PNG) Е представляется упорядоченной парой (*u*, *v*), узел *u* называется начальным, узел *v* - конечным.
...
Путь строиться путь от начального узла до конечного, что является входными данными (начальный и конечный узел). Кратчайший путь в обычном графе называется путь с наименьшим количеством рёбер от начального узла до конечного.
		...
		&& НачальныйУзел.КоличествоГраней > 0)
	{
		for (Число i = 0; i < НачальныйУзел.КоличествоГраней; i++)
		{
			...
			aциклическиеПути.AddRange(
				НайтиВсеМаршруты(
				весТекущегоРузельтата + грань.Вес
